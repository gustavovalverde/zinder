...
use crate::artifact_builder::{CommitmentTreeSizes, finalize_canonical_block};
    ...
    Source: NodeSource + Clone,
{
    ...
    loop {
        ...
        for prepared in prepared_chunk {
            ...
            let block = match finalize_canonical_block(prepared.prepared, &mut running_tree_sizes)
