...
struct CanonicalAdmission {
    ...
    visible_logical_block_facts_bytes: u64,
    settled_tip: BlockId,
...
fn decode_ready_evidence(
    ...
    Ok(DecodedCanonicalReadyEvidence {
        ...
        visible_logical_block_facts_bytes: ready.visible_logical_block_facts_bytes,
...
impl CanonicalCheckpointManifest {
    fn from_admitted(canonical: &CanonicalAdmission) -> Self {
        Self {
            ...
            visible_logical_block_facts_bytes: canonical.visible_logical_block_facts_bytes,
...
mod tests {
    ...
    fn sample_canonical_admission(sequence: u64) -> CanonicalAdmission {
        ...
        CanonicalAdmission {
            ...
            visible_logical_block_facts_bytes: sequence * 100,
            settled_tip,
