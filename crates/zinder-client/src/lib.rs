...
pub use zinder_proto::capabilities::{
    ...
    EXPLORER_SERVER_INFO_V1, EXPLORER_TRANSACTION_DETAIL_V3, EXPLORER_TRANSACTION_FEES_V1,
    ...
    WALLET_READ_VISIBLE_TIP_BLOCK_V1, WALLET_SNAPSHOT_MEMPOOL_V1, always_on_capability_strings,
