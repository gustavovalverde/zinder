...
pub use canonical_store::{
    ...
    CanonicalEventFenceDecodeError, CanonicalEventHistoryRequest, CanonicalEventKind,
    CanonicalEventRetentionReport,
    ...
    CanonicalStoreBuildState, CanonicalStoreConstructionIdentity,
    CanonicalStoreConstructionIdentityDecodeError, CanonicalStoreError,
    CanonicalStoreReadyEvidence, CanonicalStoreWorkload, CanonicalSubtreeRootLoadEvidence,
