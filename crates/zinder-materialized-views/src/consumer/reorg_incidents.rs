...
use crate::consumer::{
    ChainCommittedEvent, ChainReorgedEvent, CommittedRange, MaterializedViewConsumer,
    MaterializedViewConsumerCtx, MaterializedViewConsumerError, MaterializedViewConsumerName,
    MaterializedViewConsumerSchema, RevertedRange,
};
...
pub const REORG_INCIDENTS_CONSUMER_NAME: MaterializedViewConsumerName =
    MaterializedViewConsumerName::from_static("reorg_incidents");

/// On-disk schema declaration for the reorg-incidents materialized-view consumer.
pub const REORG_INCIDENTS_SCHEMA: MaterializedViewConsumerSchema =
...
impl MaterializedViewConsumer for ReorgIncidentsConsumer {
