...
use crate::{
    ...
    CONVENTIONAL_FEE_DISTRIBUTION_SCHEMA, DeriveConsumerSchema, IRONWOOD_MIGRATION_SCHEMA,
    MEMPOOL_EVENT_COUNTS_SCHEMA, PAID_FEE_DISTRIBUTION_SCHEMA, ProjectionPreset,
...
pub struct ProjectionDefinition {
    ...
    pub schema: DeriveConsumerSchema,
