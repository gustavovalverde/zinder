...
use zinder_derive::{
    ...
    DeriveConsumerCtx, DeriveStore, DeriveStoreOptions, TransparentSpendFacts,
    VALUE_POOL_BALANCE_HISTORY_COLUMN_FAMILY, VALUE_POOL_BALANCE_HISTORY_SCHEMA,
    ValuePoolBalanceBackfillCoverage, ValuePoolBalanceHistoryConsumer, ValuePoolBalancePoint,
