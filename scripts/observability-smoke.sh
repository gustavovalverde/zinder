...
SOURCE_SEGMENT_MAX_BLOCKS="${ZINDER_OBSERVABILITY_SOURCE_SEGMENT_MAX_BLOCKS:-128}"
SOURCE_SEGMENT_TARGET_RESPONSE_BYTES="${ZINDER_OBSERVABILITY_SOURCE_SEGMENT_TARGET_RESPONSE_BYTES:-50331648}"
SOURCE_FETCH_MAX_IN_FLIGHT_REQUESTS="${ZINDER_OBSERVABILITY_SOURCE_FETCH_MAX_IN_FLIGHT_REQUESTS:-8}"
SOURCE_FETCH_MAX_IN_FLIGHT_BYTES="${ZINDER_OBSERVABILITY_SOURCE_FETCH_MAX_IN_FLIGHT_BYTES:-268435456}"
